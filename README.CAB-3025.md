...
*Community Asset Bundle 3025* is a curated selection of Inner Sphere BattleMechs available in the Inner Sphere in the early 3025s. It's designed for mod packs that want to stick to the 3025 timeframe, but still want Age of War, Star League, and other designs. 

The list of available units changes over time; look in /assetbundles/ directory for a comprehensive list. 

Some models include the modeler's name in the assetbundle name. `chrprfmech_ionlongbowbase-001` is the LongBow model, created by IonRaptor.
